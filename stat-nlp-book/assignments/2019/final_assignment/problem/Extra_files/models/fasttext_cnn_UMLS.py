...
from tensorflow.keras.layers import Dense, Embedding, Input, Concatenate, Conv1D, Flatten, Dropout
...
class fasttext_cnn_UMLS_model:
    def __init__(self, filters=200, dyn_out_len=100, name: str = ''):
        ...
        self.base_dir = os.path.join(os.getcwd(), 'Extra_files/resources/',
                                     self.__class__.__name__ + '_' + str(filters) + '_' + str(dyn_out_len))
    ...
    def load(self, file_name):
        print(os.path.join(self.final_dir, file_name))
