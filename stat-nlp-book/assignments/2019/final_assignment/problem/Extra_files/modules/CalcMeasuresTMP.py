...
def calcMeasures(folder_gold="data/dev/", folder_pred="data_pred/dev/", remove_anno = ""):
    '''
    ...
    for f in flist_gold:
        ...
        try:
            ...
            res_full_pred, res_pred, spans_pred, rels_pred = normaliseAnn(f_pred, remove_anno)
        except IOError:
        ...
        res_full_gold, res_gold, spans_gold, rels_gold = normaliseAnn(f_gold, remove_anno)
...
def normaliseAnn(file_anno, remove_anno):
    '''
